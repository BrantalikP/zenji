...
import Svg, { SvgProps, Defs, Path, Mask, Use } from 'react-native-svg'

import { hs, vs } from '../utils/resize/resize'
export const Storybook = (props: SvgProps) => (
  <Svg width={hs(30)} height={vs(37.39)} viewBox="0 0 256 319" {...props}>
    <Defs>
      <Path
        id="a"
